#ifndef ZXMLERROR_CPP
#define ZXMLERROR_CPP
 ...
 */
struct { const char* StrErrDomain; const char* LibErrDomain; } xmlDomainCode []=
{
    {"XML_FROM_NONE" ,"No xml error domain" } ,
 ...
 */
struct xmlErrCodeElement { char* StrCode; int NumCode; } ;
static struct { char* StrCode; int NumCode; } xmlErrorCode []=
{
{"XML_ERR_OK",  0 },
...
const char*
decodeXMLErrorSymbol (int pXMLErrNum)
{
size_t wXMLErrArrayCount= sizeof(xmlErrorCode)/sizeof(xmlErrCodeElement);
size_t wi=0;
    for (wi=0;wi<wXMLErrArrayCount;wi++)
    {
        if (xmlErrorCode[wi].NumCode==pXMLErrNum)
                            return xmlErrorCode[wi].StrCode;
    }
    return "XML_UNKNOW_ERRCODE";
}// getXMLErrorSymbol

const char*
decodeXMLDomainSymbol (int pXMLDomainNum)
{
size_t wXMLDomainArrayCount= sizeof(xmlDomainCode)/sizeof(xmlErrDomainElement);
size_t wi=0;

    if ((pXMLDomainNum<0)||(pXMLDomainNum >= wXMLDomainArrayCount))
                                            return "XML_INVALID_DOMAIN";
    return xmlDomainCode[pXMLDomainNum].StrErrDomain;
}// getXMLDomainSymbol

const char*
decodeXMLDomainDesc (int pXMLDomainNum)
{
size_t wXMLDomainArrayCount= sizeof(xmlDomainCode)/sizeof(xmlErrDomainElement);
size_t wi=0;
    ...
    if ((pXMLDomainNum<0)||(pXMLDomainNum >= wXMLDomainArrayCount))
                                            return "XML_INVALID_DOMAIN";
    return xmlDomainCode[pXMLDomainNum].LibErrDomain;
}// getXMLDomainDesc


const char*
decodeXMLLevel(int pLevel)
{
    switch (pLevel)
    {
    case XML_ERR_NONE:
